  ...
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          "relative inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-main-background px-4 py-2 transition-all duration-200",
          "text-foreground hover:bg-main-foreground/40",
          className,
        )}
      />
    ),
